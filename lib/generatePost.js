...
const PLATFORM_BRIEF = {
  ...
  twitter:
    "A single tweet, under 280 characters. Punchy, no fluff, at most 2 hashtags.",
};
...
function buildFallbackPost(summary, platform = "linkedin") {
  ...
  if (safePlatform === "twitter") {
    return `This week on GitHub: ${commitText}, ${prText}, and ${repoText}. I shipped around ${projectNames}. ${langText}`.slice(0, 280);
  }
